...
export const products: Product[] = [
  // T-Shirts (8)
  {
    id: "tee-freedom-discipline",
    name: '"Freedom Is A Discipline" Tee',
    price: "$59.99",
    image: tshirtImg,
    ...
    sizes: APPAREL_SIZES,
    description: "Premium heavyweight cotton tee. FREEDOM IS A DISCIPLINE — distressed screen print with gold star accents. Pre-shrunk, tagless. For those who understand liberty demands work.",
  },
  {
    id: "tee-eagle-permission",
    name: '"The Eagle Doesn\'t Ask Permission" Tee',
    price: "$59.99",
    image: teeParasitesImg,
    tagline: "Fly Free — No Apologies",
    badge: "🔥 HOT",
    category: "apparel",
    colors: APPAREL_COLORS,
    sizes: APPAREL_SIZES,
    description: "Fierce eagle silhouette on premium black heavyweight cotton. The Eagle Doesn't Ask Permission — raw, unapologetic, untamed. For patriots who lead, never follow.",
  },
  {
    id: "tee-forged",
    name: '"Forged. Not Formed." Tee',
    price: "$59.99",
    image: teeTakebackImg,
    tagline: "Built Through Fire",
    badge: "NEW DROP",
    category: "apparel",
    colors: APPAREL_COLORS,
    sizes: APPAREL_SIZES,
    description: "Minimalist chest hit on premium black cotton. FORGED. NOT FORMED. — clean streetwear for those shaped by adversity, not assembly lines. Sleeve print ready.",
  },
  {
    id: "tee-they-slept",
    name: '"They Slept. We Rose." Tee',
    price: "$59.99",
    image: tee3Img,
    tagline: "While They Dreamed — We Built",
    badge: "🔥 HOT",
    category: "apparel",
    colors: APPAREL_COLORS,
    sizes: APPAREL_SIZES,
    description: "Bold gold and white distressed print on premium black cotton. THEY SLEPT. WE ROSE. — a statement for the awakened who never waited for permission to stand up.",
  },
  {
    ...
    price: "$59.99",
    image: tee4Img,
    tagline: "The Motto — Worn With Pride",
    badge: "BESTSELLER",
    category: "apparel",
    colors: APPAREL_COLORS,
    sizes: APPAREL_SIZES,
    description: "Three gold stars and decorative lines frame our core motto: TRUTH SHALL PREVAIL. Premium black heavyweight cotton. The Awakened 1776 signature design.",
  },
  {
    id: "tee-drain-rats",
    ...
    colors: APPAREL_COLORS,
    sizes: APPAREL_SIZES,
    description: "American flag skull on premium black cotton. DRAIN EVERY LAST RAT — no exceptions, no deals, no mercy. The cleanup starts now.",
  },
  {
    id: "tee-born-awake",
    name: '"Born Awake" Tee',
    price: "$59.99",
    image: tee6Img,
    tagline: "Always Was — Always Will Be",
    badge: "NEW DROP",
    category: "apparel",
    colors: APPAREL_COLORS,
    sizes: APPAREL_SIZES,
    description: "Minimal, clean, embroidery-style print on premium black cotton. BORN AWAKE — for those who never needed a wake-up call. Any placement. Maximum impact.",
  },
  {
    id: "tee-awake-since",
    name: '"Awake Since 1776" Tee',
    price: "$59.99",
    image: tee5Img,
    tagline: "The Spirit Never Died",
    badge: "FAN FAVORITE",
    category: "apparel",
    colors: APPAREL_COLORS,
    sizes: APPAREL_SIZES,
    description: "Screaming eagle with AWAKE SINCE 1776 vintage print on premium black cotton. The signature line — use it, wear it, live it. The spirit of the founders lives in you.",
  },
  // Hoodies (7)
  {
    id: "hoodie-awake-since",
    name: '"Awake Since 1776" Hoodie',
    price: "$109.99",
    image: hoodieImg,
    tagline: "The Signature — Gold On Black",
    badge: "BESTSELLER",
    category: "apparel",
    colors: APPAREL_COLORS,
    sizes: APPAREL_SIZES,
    description: "Gold distressed AWAKE SINCE 1776 on jet black heavyweight fleece. Three stars, front pouch pocket. Our signature line on our signature hoodie. The one that started it all.",
  },
  {
    id: "hoodie-never-caged",
    name: '"Never Caged. Never Tamed." Hoodie',
    price: "$109.99",
    image: hoodie2Img,
    tagline: "Wild And Free — Always",
    badge: "🔥 HOT",
    category: "apparel",
    colors: APPAREL_COLORS,
    sizes: APPAREL_SIZES,
    description: "Bold distressed white print on premium black heavyweight fleece. NEVER CAGED. NEVER TAMED. Double-lined hood, metal grommets. For those who refuse to be boxed in.",
  },
  {
    id: "hoodie-independence",
    name: '"Independence Is A Mindset" Hoodie',
    price: "$109.99",
    image: hoodie3Img,
    tagline: "Think Free — Live Free",
    badge: "NEW DROP",
    category: "apparel",
    colors: APPAREL_COLORS,
    sizes: APPAREL_SIZES,
    description: "Back print on jet black heavyweight fleece. INDEPENDENCE IS A MINDSET — not just a day on the calendar. Oversized drop shoulder fit. Deep thought, deeper conviction.",
  },
  {
    id: "hoodie-mind-unlocked",
    name: '"Mind Unlocked. Soul On Fire." Hoodie',
    price: "$109.99",
    image: hoodie4Img,
    tagline: "Ignite The Revolution Within",
    badge: "🔥 HOT",
    category: "apparel",
    colors: APPAREL_COLORS,
    sizes: APPAREL_SIZES,
    description: "Fire gradient text with flame graphics on premium black fleece. MIND UNLOCKED. SOUL ON FIRE. — premium limited drop for the spiritually awakened warrior.",
  },
  {
    id: "hoodie-original-patriots",
    name: '"Original Patriots Don\'t Follow" Hoodie',
    price: "$109.99",
    image: hoodieParasitesImg,
    tagline: "Lead Or Get Out Of The Way",
    badge: "NEW",
    category: "apparel",
    colors: APPAREL_COLORS,
    sizes: APPAREL_SIZES,
    description: "Bold white distressed print on black heavyweight fleece. ORIGINAL PATRIOTS DON'T FOLLOW — heritage-inspired for those who forge their own path. Front panel, back full print ready.",
  },
  {
    id: "hoodie-built-america",
    name: '"Built In America. Worn With Purpose." Hoodie',
    price: "$109.99",
    image: hoodieOurRulesImg,
    tagline: "Made Here — Meant Something",
    badge: "LIMITED",
    category: "apparel",
    colors: APPAREL_COLORS,
    sizes: APPAREL_SIZES,
    description: "White print with American flag detail on olive heavyweight fleece. BUILT IN AMERICA. WORN WITH PURPOSE. Military-inspired comfort, revolutionary message. Back lower hem tag.",
  },
  {
    ...
    tagline: "The Campaign — Starts Now",
    badge: "NEW DROP",
    category: "apparel",
    colors: APPAREL_COLORS,
    sizes: APPAREL_SIZES,
    description: "Fire-to-gold gradient text on jet black heavyweight fleece. AWAKEN EVERYTHING — our campaign call to action. Front pouch pocket, double-lined hood. Wake up the world.",
  },
  // Tank Tops (6)
  {
    id: "tank-freedom-discipline",
    name: '"Freedom Is A Discipline" Tank',
    price: "$49.99",
    image: tank1Img,
    tagline: "Gym-Ready Truth",
    badge: "NEW",
    category: "tank-tops",
    colors: TANK_COLORS,
    sizes: TANK_SIZES,
    description: "Bold print with gold star accents on black athletic tank. FREEDOM IS A DISCIPLINE — for the gym, the streets, and the movement. Moisture-wicking, breathable.",
  },
  {
    id: "tank-forged",
    name: '"Forged. Not Formed." Tank',
    price: "$49.99",
    image: tank2Img,
    tagline: "Strength Through Fire",
    badge: "BESTSELLER",
    category: "tank-tops",
    colors: TANK_COLORS,
    sizes: TANK_SIZES,
    description: "Clean minimalist chest print on black athletic tank. FORGED. NOT FORMED. — you weren't assembled, you were tempered. Moisture-wicking blend.",
  },
  {
    id: "tank-they-slept",
    name: '"They Slept. We Rose." Tank',
    price: "$49.99",
    image: tankDrainImg,
    tagline: "Gold And White Statement",
    badge: "🔥 HOT",
    category: "tank-tops",
    colors: TANK_COLORS,
    sizes: TANK_SIZES,
    description: "Bold gold and white distressed print on black athletic tank. THEY SLEPT. WE ROSE. — wear the statement that says you were never asleep. Gym-ready, march-ready.",
  },
  {
    id: "tank-never-caged",
    name: '"Never Caged. Never Tamed." Tank',
    price: "$49.99",
    ...
    colors: TANK_COLORS,
    sizes: TANK_SIZES,
    description: "Bold white print on black athletic tank. NEVER CAGED. NEVER TAMED. — for those who refuse to be contained. Reinforced shoulders, breathable cut.",
  },
  {
    id: "tank-born-awake",
    name: '"Born Awake" Tank',
    price: "$49.99",
    image: tankComingImg,
    tagline: "Minimal — Maximum Impact",
    badge: "LIMITED",
    category: "tank-tops",
    colors: TANK_COLORS,
    sizes: TANK_SIZES,
    description: "Clean minimal white text on black athletic tank. BORN AWAKE — embroidery-style print. Lightweight, breathable, ready for anything.",
  },
  {
    id: "tank-eagle-permission",
    name: '"The Eagle Doesn\'t Ask Permission" Tank',
    price: "$49.99",
    image: tank6Img,
    tagline: "Wings Out — No Limits",
    badge: "FAN FAVORITE",
    category: "tank-tops",
    colors: TANK_COLORS,
    sizes: TANK_SIZES,
