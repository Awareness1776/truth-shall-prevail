...
export const products: Product[] = [
  ...
  {
    id: "tee-parasites",
    name: '"No More Parasites" Tee',
    price: "$59.99",
    image: teeParasitesImg,
    tagline: "Remove The Corruption",
    badge: "🔥 HOT",
    category: "apparel",
    colors: APPAREL_COLORS,
    sizes: APPAREL_SIZES,
    description: "No More Parasites In Power — rattlesnake graphic on premium black heavyweight cotton. The message they don't want you wearing.",
  },
  {
    id: "tee-takeback",
    name: '"Take Back What\'s Ours" Tee',
    price: "$59.99",
    image: teeTakebackImg,
    tagline: "Eagle Edition — Navy",
    badge: "NEW DROP",
    category: "apparel",
    colors: APPAREL_COLORS,
    sizes: APPAREL_SIZES,
    description: "Take Back What's Ours — golden eagle emblem on navy premium cotton. Reclaim what belongs to the people.",
  },
  {
  ...
  {
    id: "tee-drain",
    name: '"Drain Every Last One" Tee',
    price: "$59.99",
    image: teeDrainImg,
    tagline: "Flag Skull — No Mercy",
    badge: "LIMITED",
    category: "apparel",
    colors: APPAREL_COLORS,
    sizes: APPAREL_SIZES,
    description: "Drain Every Last One — American flag skull on premium black cotton. The cleanup starts now.",
  },
  {
    id: "tee-land-free",
  ...
  {
    id: "hoodie-parasites",
    name: '"No More Parasites" Hoodie',
    price: "$109.99",
    image: hoodieParasitesImg,
    tagline: "Rattlesnake — Crimson Red",
    badge: "🔥 HOT",
    category: "apparel",
    colors: APPAREL_COLORS,
    sizes: APPAREL_SIZES,
    description: "No More Parasites In Power on crimson red heavyweight fleece. Rattlesnake graphic, double-lined hood. They'll see you coming.",
  },
  {
    id: "hoodie-our-rules",
    name: '"Our Country, Our Rules" Hoodie',
    price: "$109.99",
    image: hoodieOurRulesImg,
    tagline: "Crossed Muskets — Olive",
    badge: "NEW DROP",
    category: "apparel",
    colors: APPAREL_COLORS,
    sizes: APPAREL_SIZES,
    description: "Our Country, Our Rules — crossed muskets on olive heavyweight fleece. Military-grade comfort, revolutionary message.",
  },
  {
    id: "hoodie-coming",
    name: '"The People Are Coming" Hoodie',
    price: "$109.99",
    image: hoodieComingImg,
    tagline: "13 Stars — Black Edition",
    badge: "LIMITED",
    category: "apparel",
    colors: APPAREL_COLORS,
    sizes: APPAREL_SIZES,
    description: "The People Are Coming on jet black heavyweight fleece. 13-star emblem, front pouch pocket. The warning they can't ignore.",
  },
  // Tank Tops (6)
  {
    id: "tank-wtp",
  ...
  {
    id: "tank-drain",
    name: '"Drain Every Last One" Tank',
    price: "$49.99",
    image: tankDrainImg,
    tagline: "Flag Skull — Black",
    badge: "🔥 HOT",
    category: "tank-tops",
    colors: TANK_COLORS,
    sizes: TANK_SIZES,
    description: "Drain Every Last One — flag skull on black athletic tank. Moisture-wicking, built for the gym and the movement.",
  },
  {
    id: "tank-takeback",
    name: '"Take Back What\'s Ours" Tank',
    price: "$49.99",
    image: tankTakebackImg,
    tagline: "Eagle Crest — White",
    badge: "NEW DROP",
    category: "tank-tops",
    colors: TANK_COLORS,
    sizes: TANK_SIZES,
    description: "Take Back What's Ours — eagle crest on white athletic tank. Bold red and navy print, reinforced shoulders.",
  },
  {
    id: "tank-coming",
    name: '"The People Are Coming" Tank',
    price: "$49.99",
    image: tankComingImg,
    tagline: "13 Stars — Heather Gray",
    badge: "LIMITED",
    category: "tank-tops",
    colors: TANK_COLORS,
    sizes: TANK_SIZES,
    description: "The People Are Coming — 13-star circle stamp on heather gray tank. Lightweight, breathable, ready for anything.",
  },
  {
    id: "tank-had-enough",
