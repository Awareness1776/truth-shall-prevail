...
export const products: Product[] = [
  ...
  {
    id: "tank-accountability",
    name: '"Hold Them Accountable" Tank',
    price: "$49.99",
    image: tankComingImg,
    tagline: "No One Escapes Justice",
    badge: "LIMITED",
    category: "tank-tops",
    colors: TANK_COLORS,
    sizes: TANK_SIZES,
    description: "Hold Them Accountable — 13-star circle stamp on heather gray tank. Every corrupt politician, every name on that list, every sellout in Congress — we demand answers. Lightweight, breathable, ready for the march.",
  },
  {
    id: "tank-had-enough",
