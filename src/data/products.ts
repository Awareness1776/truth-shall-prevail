...
export const products: Product[] = [
  ...
  {
    id: "mug-76-mark",
    name: '"76" Brand Mark Mug',
    price: "$34.99",
    image: mugImg,
    tagline: "The Iconic 76 — Black Ceramic",
    badge: "BESTSELLER",
    category: "mugs",
    colors: MUG_COLORS,
    description: "Gold 76 brand mark on glossy black ceramic. AWAKENED · EST. 1776. 11oz, dishwasher and microwave safe.",
  },
  {
    id: "mug-awakened-collegiate",
    name: '"Awakened 1776" Collegiate Mug',
    price: "$34.99",
    image: mug2Img,
    tagline: "The Arched Classic — Dark Ceramic",
    badge: "NEW",
    category: "mugs",
    colors: MUG_COLORS,
    description: "Bold AWAKENED text with red 1776 on dark ceramic. The collegiate brand identity mug. 11oz.",
  },
  {
    id: "mug-truth-prevail",
    name: '"Truth Shall Prevail" Mug',
    price: "$39.99",
    image: mug3Img,
    tagline: "The Motto — Navy & Gold",
    badge: "🔥 HOT",
    category: "mugs",
    colors: MUG_COLORS,
    description: "TRUTH SHALL PREVAIL in bold gold on navy ceramic with stars and AWAKENED 1776. Premium 15oz size.",
  },
  {
    id: "mug-eagle-quote",
    name: '"The Eagle Rises" Mug',
    price: "$34.99",
    image: mug4Img,
    tagline: "Rise Above It — Gold Script",
    badge: "FAN FAVORITE",
    category: "mugs",
    colors: MUG_COLORS,
    description: "The eagle does not fight the storm — it rises above it. Gold script on matte black ceramic. AWAKENED 1776. 11oz.",
  },
  {
    id: "mug-a-stamp",
    name: '"A" Stamp Mark Mug',
    price: "$39.99",
    image: mug5Img,
    tagline: "The Spirit Lives On — Black & Gold",
    badge: "LIMITED",
    category: "mugs",
    colors: MUG_COLORS,
    description: "Gold 'A' stamp logo in bordered frame on glossy black ceramic. AWAKENED · 1776 · THE SPIRIT LIVES ON. 15oz premium.",
  },
  {
    id: "mug-sovereign",
    name: '"Simple. Sovereign. Undefeated." Mug',
    price: "$34.99",
    image: mug6Img,
    tagline: "Brand Values — White & Gold",
    badge: "NEW DROP",
    category: "mugs",
    colors: MUG_COLORS,
    description: "SIMPLE. SOVEREIGN. UNDEFEATED. in gold on white ceramic with gold rim. AWAKENED 1776. Elegant and patriotic. 11oz.",
  },
  // Drinkware / Water Bottles (6)
  {
    id: "bottle-76-mark",
    name: '"76" Brand Mark Bottle',
    price: "$49.99",
    image: bottleImg,
    tagline: "32oz Stainless — Gold 76 Engraved",
    badge: "BESTSELLER",
    category: "drinkware",
    colors: BOTTLE_COLORS,
    description: "Gold 76 brand mark laser-engraved on stainless steel. AWAKENED · EST. 1776. 32oz vacuum-insulated, keeps drinks cold 24hrs.",
  },
  {
    id: "bottle-awakened",
    name: '"Awakened 1776" Bottle',
    price: "$49.99",
    image: bottle2Img,
    tagline: "32oz Matte Black — Gold Print",
    badge: "NEW",
    category: "drinkware",
    colors: BOTTLE_COLORS,
    description: "AWAKENED 1776 in arched gold on matte black stainless steel. 32oz vacuum-insulated. BPA-free, leak-proof lid.",
  },
  {
    id: "bottle-truth-prevail",
    name: '"Truth Shall Prevail" Bottle',
    price: "$54.99",
    image: bottle3Img,
    tagline: "32oz Navy — Gold Engraved",
    badge: "🔥 HOT",
    category: "drinkware",
    colors: BOTTLE_COLORS,
    description: "TRUTH SHALL PREVAIL laser-engraved in gold on navy steel with AWAKENED 1776 below. 32oz vacuum-insulated.",
  },
  {
    id: "bottle-a-stamp",
    name: '"A" Stamp Mark Bottle',
    price: "$54.99",
    image: bottle4Img,
    tagline: "32oz Matte Black — A Logo",
    badge: "LIMITED",
    category: "drinkware",
    colors: BOTTLE_COLORS,
    description: "Gold 'A' stamp logo in bordered frame laser-engraved on matte black steel. AWAKENED 1776. 32oz vacuum-insulated.",
  },
  {
    id: "bottle-born-to-soar",
    name: '"Born To Soar" Bottle',
    price: "$49.99",
    image: bottle5Img,
    tagline: "32oz Olive — Gold Engraved",
    badge: "NEW DROP",
    category: "drinkware",
    colors: BOTTLE_COLORS,
    description: "BORN TO SOAR NOT TO BOW laser-engraved in gold on olive drab steel. AWAKENED 1776. 32oz vacuum-insulated.",
  },
  {
    id: "shaker-sovereign",
    name: '"Simple. Sovereign. Undefeated." Shaker',
    price: "$42.99",
    image: shakerImg,
    tagline: "28oz Stainless — Brand Values",
    badge: "NEW",
    category: "drinkware",
    colors: BOTTLE_COLORS,
    description: "SIMPLE. SOVEREIGN. UNDEFEATED. in gold on stainless steel shaker. AWAKENED 1776. 28oz, mixing ball included, leak-proof twist lid.",
  },
  // Accessories
  {
    id: "patch-wtp",
